...
if predict_clicked:
    if not input_sms.strip():
        ...
        if result == 1:
            ...
            st.markdown('<span class="ss-label">Confidence Breakdown</span>', unsafe_allow_html=True)
...
st.markdown("""
<div class="ss-footer">
    Built with Streamlit &amp; scikit-learn &nbsp;·&nbsp; Dataset: SMS Spam Collection<br>
    <span style="color:#58D5D8; font-family:'Space Grotesk',sans-serif; font-weight:600;">Random Forest Classifier</span>
    &nbsp;·&nbsp;
    <span style="color:#58D5D8; font-family:'Space Grotesk',sans-serif; font-weight:600;">Accuracy: 97.2%</span>
    <br><span style="color:#30363D">SpamShield v1.0</span>
</div>
""", unsafe_allow_html=True)